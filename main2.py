...
'''
        ...
        def on_start(self):
            ...
            self.img_texture = self.app.root.get_screen('start_screen_name').ids["image_textureID"]
            Clock.schedule_once(self.init_cv, 5)
        ...
        def init_cv(self, *args):
            ...
            Clock.schedule_interval(self.blit_from_shared_memory, 1/10)
        ...
        def blit_from_shared_memory(self, *args):
            ...
            if len(shared_analysis_dict) > 0:
                ...
                self.img_texture.texture = texture1
